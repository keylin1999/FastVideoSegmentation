...
class TensorboardLogger:
    def __init__(self, short_id, git_info, root_path="."):
        """
        root_path: path to the directory which stores the model checkpoints
        """
        ...
        log_path = os.path.join(root_path, short_id)
